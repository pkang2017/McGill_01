...
print(adj)
if FLAGS.features == 0:
    features = sp.identity(features.shape[0])  # featureless features = sp.identity(adj.shape[0])

# Some preprocessing
adj_norm = preprocess_graph(adj)        #some problem, some rows are zeros totally
